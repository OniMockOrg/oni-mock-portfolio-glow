...
const ko: LanguageFile = {
  ...
  translations: {
    ...
    'services.automation.description':
      'AlphaBot 플랫폼을 통한 포괄적인 추첨 자동화 시스템. 참가자 등록부터 당첨자 선정까지 효율적이고 신뢰할 수 있는 추첨 관리 솔루션을 제공합니다.',
    ...
    'contact.form.email.placeholder': '귀하의 이메일',
    'contact.form.subject': '제목',
    'contact.form.subject.placeholder': '메시지 제목',
    'contact.form.message': '메시지',
    'contact.form.message.placeholder': '귀하의 메시지',
    ...
    'alphabot.hero.description':
      '우리의 고급 자동화 시스템으로 추첨 관리를 혁신하세요. 참가자 등록부터 당첨자 선택까지, AlphaBot은 완전하고 신뢰할 수 있는 솔루션을 제공합니다.',
