...
const zh: LanguageFile = {
  ...
  translations: {
    ...
    'services.automation.description':
      '通过AlphaBot平台提供完整的抽奖自动化系统。我们提供高效可靠的抽奖管理解决方案，从参与者注册到获奖者选择。',
    ...
    'alphabot.hero.description':
      '使用我们先进的自动化系统改变您的抽奖管理。从参与者注册到获奖者选择，AlphaBot 提供完整可靠的解决方案。',
    ...
    'alphabot.sections.automation.description':
      '通过效率最大化您的机会！在 Alphabot 平台上自动化注册，节省时间并增加获得 NFT 的机会。',
    'alphabot.sections.automation.feature1':
      '自动注册：抽奖一旦激活就立即注册您的账户。',
